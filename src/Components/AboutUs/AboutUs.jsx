...
const AboutUs = () => {
  return (
    <div >
      ...
      <section className="bg-gray-100 text-gray-800 py-5yy px-5 md:px-20">
        ...
        <div className='max-w-screen-xl mx-auto'>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-14">
            <div>
              <h4 className="text-xl font-bold mb-2 text-purple-500">Mission Statement</h4>
              <p className="text-gray-700">
            ...
            <div>
              <h4 className="text-xl font-bold mb-2 text-purple-500">Our Story / How It Started</h4>
              <p className="text-gray-700">
