...
const SignUp = () => {
  ...
  const { setUser, updateUser, createUser, googleSignIn } = use(AuthContext)
      ...
      <div className="hero bg-base-200 min-h-screen">
        ...
        <div className="card bg-base-100 w-full max-w-sm  shadow-2xl">
          <div className="card-body">
            <h1 className="text-4xl font-bold text-center text-purple-500">Sign Up now!</h1>
            <h3 className=' text-center  text-cyan-500'>
              <Typewriter
                delaySpeed={1000}
                deleteSpeed={25}
                loop={0}
                typeSpeed={75}
                words={[
                  "Create your profile. Meet your match.",
                  "Your ideal roommate is waiting...",
                ]}
              />
            </h3>
            <form onSubmit={handleSignUp} className="fieldset">
              ...
              <button onClick={handleGoogleLogin} className="btn outline outline-primary md:text-lg bg-white">
              ...
              <p className='md:text-lg mt-2 text-center'>Already have an account? <Link to='/login' className='text-purple-500 md:text-lg hover:underline'>Login Now</Link></p>
            </form>
          </div>
        </div>
      </div>
